...
<div class="container pt-5">
	<h1 class="text-center mt-5"><i>Lobelia Social Network</i></h1><hr> 
  <div class="d-flex p-3 text-white justify-content-center"> 
	<button class="btn btn-info text-right mr-2" data-toggle="modal" data-target="#registerModal"><i class="fas fa-registered mr-1"></i>Register</button>
	<button class="btn btn-success" data-toggle="modal" data-target="#loginModal"><i class="fas fa-sign-in-alt mr-1"></i>Login</button>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i>Registration Form</i></h5>
...
<div class="modal fade" id="loginModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i>Login Form</i></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
        <button type="submit" class="btn btn-secondary"><i class="fas fa-registered mr-1"></i>Login</button>
      </div>
      </form>
    </div>
  </div>
